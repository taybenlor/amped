var iPhoneStyle = function(selector_or_elems, options) {
  ...
  return(elems.each(function(elem) {
    ...
    var rightside = container.getWidth() - handle.getWidth() - 14;
...
Event.observe(document, 'dom:loaded', function(){
  ...
  if ($$('input[type=checkbox].switch').first()) {
    new iPhoneStyle('input[type=checkbox].switch', { checkedLabel: '<img src="/images/switch/on_label.png" style="width:26;padding-right:40px;padding-top:4px;padding-left:6px"/>', uncheckedLabel: '<img src="/images/switch/off_label.png" style="width:31;padding-right:15px;padding-top:4px;padding-left:15px"/>' });
                    // Acts like $$
  }
});